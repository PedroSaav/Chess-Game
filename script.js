//Wait for the DOM to be fully loaded beofre executing code
document.addEventListener('DOMContentLoaded', () => {
  ...
  //Function to handle the start fo a drag position
...
// Inicializar la chessboard
board = ChessBoard('board', boardConfig);

//Event Listener para el "Play Again" button
...
('click', () => {
  ...
  userColor = 'w';
   ...
   //Event Listener para el "Set Position" Button
